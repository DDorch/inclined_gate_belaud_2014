...
% h1=hauteur d'eau au niveau de la section contract�e
% s=h1/H0
% a=W/H0
...
for k=N1:N2
    ...
    [Q, h1, etatVanne, Cd, Cc_app, dQdW, dQdhm, dQdhv, nbIter] = CalculQ(h0, z2, pelle_aval, W, angle, Cc0, B, B2, corr);
...
function [Q, h1, etatVanne, Cd, Cc_app, dQdW, dQdhm, dQdhv, nbIter] = CalculQ(h0, z2, pelle_aval, W, angle, Cc0, B, B2, corr)
